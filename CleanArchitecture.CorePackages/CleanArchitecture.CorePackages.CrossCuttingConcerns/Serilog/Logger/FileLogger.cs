...
public class FileLogger:LoggerServiceBase
{
    ...
    public FileLogger(IConfiguration configuration)
    {
        ...
        string logFilePath = string.Format(format: "{0}{1}", arg0:Directory.GetCurrentDirectory() + fileLogConfiguration.FolderPath, arg1: ".txt");
        Logger = new LoggerConfiguration().WriteTo.File(
            logFilePath, rollingInterval: RollingInterval.Day, 
            retainedFileCountLimit: null,fileSizeLimitBytes:5000000,
